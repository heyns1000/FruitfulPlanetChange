...
export function Sidebar({ activePage, onPageChange, setActivePage }: SidebarProps) {
  ...
  const ecosystemItems = [
    { id: 'faa-quantum-nexus', label: '🚀 FAA Quantum Nexus™', icon: '⚡', badge: 'AI Economic' },
    {
      ...
      label: '💼 Fruitful Business Plan',
      icon: '📊',
      badge: 'R391M Strategy',
    },
    {
      id: 'samfox-creative-studio',
      label: '🎨 SamFox Creative Studio',
      icon: '✨',
      badge: 'Digital Art',
    },
    ...
    {
      id: 'sector-mapping',
      label: '🌐 Sector Relationship Map',
      icon: '🔗',
      badge: 'Interactive Network',
    },
    {
      id: 'sector-relationship-mapping',
      label: '🔗 Interactive Sector Mapping',
      icon: '🌐',
      badge: 'Network Graph',
    },
