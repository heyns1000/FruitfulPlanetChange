...
const PAYPAL_CLIENT_ID =
  ...
  'BAA8AUA8GP2Tx22g4fbtusDJW_ds4luuHrG1veJhaS2Xy5BmPi8RL46pTt3EnVg7JP156tD8SQ0Ch6TXGk';
const PAYPAL_CLIENT_SECRET =
  process.env.PAYPAL_CLIENT_SECRET ||
  'EDSlaqtreVQbGhaGFUnkoSKZ2zqQTvcRXBMJOH5qlGEacVAgKKcKktz-00nZJj3J88f9rnvaNx-k-f6G';
...
export async function createPaypalOrder(req: Request, res: Response) {
  try {
    ...
    if (!intent || !['CAPTURE', 'AUTHORIZE'].includes(intent.toUpperCase())) {
      return res.status(400).json({ error: 'Invalid intent. Must be CAPTURE or AUTHORIZE.' });
    }
